...
public class CadastrarFotoActivity extends AppCompatActivity {
    //ImageView
    ...
    public void onBackPressed()
    {
        ...
        mtoatscantback = Toast.makeText(CadastrarFotoActivity.this, "Não é possivel voltar.", Toast.LENGTH_LONG);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Database
        mCustomerDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child(sUserId);
        ...
        mbttnContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(sSelectimage[0].equals("NoSelectImage")){
                    ...
                    Toast.makeText(CadastrarFotoActivity.this, "Voce precisa adicionar uma foto ao seu perfil", Toast.LENGTH_LONG).show();
                    ...
                    new CountDownTimer(1000, 200) {
                        ...
                        public void onFinish() {
                            ...
                            //Iniciar nova intent
                            Intent intent = new Intent(CadastrarFotoActivity.this, CadastrarTipocontaActivity.class);
